...
function Reset() {
   ...
   const valuePassword = (e) => {
      setInputpending(false), setInput(true), setPassword(e.target.value);
   };

   const valueConfirm = (e) => {
      setInputpending(false), setInput(true), setConfirm(e.target.value);
   };
               ...
               <div className={css.content_right}>
                  <div className={css.content_form}>
                     ...
                     <p className={css.title_bar_2}>
                        ...
                        will send a link to your email and you will be directed
                     ...
                     <div className={css.phone_view}>
                        ...
                        <p className={css.title_bar_2_phone}>
                           Enter your FazzPay e-mail so we can send you a
                           password reset link.
                        </p>
                     </div>
                     ...
                     <button className={css.confirm} onClick={resetPassword}>
                        Reset Password
                     </button>
                  </div>
               </div>
