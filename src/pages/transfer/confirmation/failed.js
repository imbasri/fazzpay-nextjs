         ...
         <Layout title="Transfer Confirmation">
            ...
            <div className={`container-fluid ${css.background_container}`}>
               <div className={`container d-flex gap-4 ${css.content_inti}`}>
                  ...
                  <div
                     className={`col-lg-9 col-md-8 col-sm-12 ${css.content_right}`}
                  >
                     <section className={`d-flex justify-content-center mt-5`}>
                        <span>
                           ...
                           <div className={`${css.trfFail}`}>
                              Transfer Failed
                           </div>
                           <div className={`d-flex justify-content-center`}>
                              <div className={`${css.failDetail}`}>
                                 We can`t transfer your money at the moment, we
                                 recommend you to check your internet connection
                                 and try again.
                              </div>
                           </div>
                        </span>
